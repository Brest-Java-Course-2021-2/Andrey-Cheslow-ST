...
public class FootballerDto {
    ...
    public FootballerDto(Integer footballerId, String firstName, String lastName, Integer age, Double salary, Integer teamId, String teamName, LocalDate joiningDate) {
